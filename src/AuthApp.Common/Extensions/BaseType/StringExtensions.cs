...
using DnsClient;
using VCrisp.Utilities.DateTimeExt;

namespace VCrisp.Extensions.BaseType
{
    public static partial class StringExtensions
    {
        public static string JoinAsString(this IEnumerable<string> strs, string separate = ", ") => string.Join(separate, strs);
