...
namespace VCrisp.Utilities.PageHelper
{
	...
	public class PageResult<T>
	{
		...
		{
			return new PageResult<TResult>(func(Records), this.PageSize, this.TotalRecordsCount, this.TotalPagesCount);
		}

		public PageResult(IEnumerable<T> rows,int? pageSize, int totalRecordsCount, int totalPagesCount)
		{
			this.Records = rows;
