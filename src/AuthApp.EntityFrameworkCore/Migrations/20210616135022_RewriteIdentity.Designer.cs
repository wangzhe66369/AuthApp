...
namespace AuthApp.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20210616135022_RewriteIdentity")]
    partial class RewriteIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthApp.Identity.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AuthApp.Identity.Users.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AuthApp.Identity.Roles.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AuthApp.Identity.Users.User", null)
                        .WithMany()
